...
class AuthController extends GetxController {
  ...
  void showLogoutLoader(BuildContext context) {
    showDialog(
      context: context,
      barrierDismissible: false,
  ...
  void closeLogoutLoader(BuildContext context) {
  ...
  Future<void> logout(BuildContext context) async {
    ...
    try {
      ...
      await SharedPreferenceHelper.remove(SharedPrefKeys.userName);
      await SharedPreferenceHelper.remove(SharedPrefKeys.savedPassword);
      await SharedPreferenceHelper.remove(SharedPrefKeys.rememberMe);
      ApiService.clearToken();
      passwordController.clear();
      ...
      closeLogoutLoader(context); // close dialog
